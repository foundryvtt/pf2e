...
export const DamageCategory = Object.freeze({
    ...
    allCategories: () => new Set([].concat(Object.values(BASE_DAMAGE_TYPES_TO_CATEGORIES)).concat(Object.values(CUSTOM_DAMAGE_TYPES_TO_CATEGORIES))),
    ...
    currentTypeMappings: () => combineObjects(BASE_DAMAGE_TYPES_TO_CATEGORIES, CUSTOM_DAMAGE_TYPES_TO_CATEGORIES, (first, second) => second),
