...
function disableDevice(options: SkillActionOptions): void {
    ...
    const rollOptions = ["self:action:slug:disable-a-device", "self:action:slug:disable-device"];
...
const action = new SingleCheckAction({
    ...
    rollOptions: ["self:action:slug:disable-a-device", "self:action:slug:disable-device"],
    slug: "disable-device",
    statistic: "thievery",
    traits: ["manipulate"],
});
