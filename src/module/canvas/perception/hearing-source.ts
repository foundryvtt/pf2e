...
class HearingSource<TObject extends TokenPF2e> extends foundry.canvas.sources.PointSoundSource<TObject> {
    protected override _initialize(data: PointEffectSourceData): void {
