...
export class TokenRulerPF2e extends foundry.canvas.placeables.tokens.TokenRuler<TokenPF2e> {
    static override WAYPOINT_LABEL_TEMPLATE = `systems/${SYSTEM_ID}/templates/scene/token/ruler/waypoint-label.hbs`;

    static ACTION_MARKER_TEMPLATE = `systems/${SYSTEM_ID}/templates/scene/token/ruler/action-marker.hbs`;
