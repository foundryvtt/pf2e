...
import { ATTRIBUTE_ABBREVIATIONS, SAVE_TYPES, SKILL_EXPANDED, SKILL_LONG_FORMS } from "@actor/values.ts";
import type {
    AncestryPF2e,
    BackgroundPF2e,
    ClassPF2e,
...
class CharacterPF2e<TParent extends TokenDocumentPF2e | null = TokenDocumentPF2e | null> extends CreaturePF2e<TParent> {
    ...
    private prepareSkills(): CharacterSkills<this> {
        ...
        const skills = R.mapToObj(Array.from(SKILL_LONG_FORMS), (longForm) => {
        ...
        for (const loreItem of this.itemTypes.lore) {
            ...
            system.skills[longForm as SkillLongForm] = {
