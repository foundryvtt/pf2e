...
import { Migration683FlavorTextToPublicNotesAndFixBiography } from "./migrations/683-flavortext-to-publicNotes-fix-biography";
...
export class Migrations {
    private static list = [
        ...
        Migration683FlavorTextToPublicNotesAndFixBiography,
    ];
