...
class CompendiumBrowser extends Application {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      tabs: [{ navSelector: ".compendium-navigation", contentSelector: ".compendium-content", initial: "landing-page" }],
    })
  }
  ...
  hookCompendiumList() {
    Hooks.on('renderCompendiumDirectory', (app, html, data) => {
      ...
      const importButton = $('<button class="compendium-browser-btn"><i class="fas fa-fire"></i> Compendium Browser</button>');
