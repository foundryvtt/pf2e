...
export class PhysicalItemSheetPF2e<I extends PhysicalItemPF2e = PhysicalItemPF2e> extends ItemSheetPF2e<I> {
    ...
    private checkForMystifyUpdates(
        ...
        // Always make sure data has all the up to date data descriptions
        data[`data.identification.identified.data.description.value`] = this.item.data.data.identification.identified.data.description.value;
        data[`data.identification.unidentified.data.description.value`] = this.item.data.data.identification.unidentified.data.description.value;
        data[`data.identification.misidentified.data.description.value`] = this.item.data.data.identification.misidentified.data.description.value;
