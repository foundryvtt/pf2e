...
import type { AmmoBehavior, AmmoType } from "@item/consumable/types.ts";
import type {
...
interface WeaponSystemSource extends Investable<PhysicalSystemSource> {
    ...
    ammo: WeaponAmmunitionSource | null;
    usage: {
        canBeAmmo?: boolean;
...
interface WeaponAmmunitionSource {
...
interface WeaponAmmunitionData extends WeaponAmmunitionSource {
