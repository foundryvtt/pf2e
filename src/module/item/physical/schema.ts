...
/** Fields to omit from the system schema type when subclassing to avoid conflicts when overlapping */
...
export type { PhysicalItemModelOmission, PhysicalItemSystemSchema };
