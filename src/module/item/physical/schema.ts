        ...
        return {
            ...
            identification: new fields.SchemaField({
                ...
                unidentified: new fields.SchemaField({
                    ...
                    // This is a lie, but physical items currently allow blank here
                    img: new fields.StringField<ImageFilePath, ImageFilePath, true, false, true>({
                        required: true,
                        blank: true,
                        nullable: false,
                        initial: "" as ImageFilePath,
                    }),
...
type PhysicalItemSystemSchema = ItemSystemSchema & {
    ...
    identification: fields.SchemaField<{
        ...
        unidentified: fields.SchemaField<{
            ...
            img: fields.StringField<ImageFilePath, ImageFilePath, true, false, true>;
