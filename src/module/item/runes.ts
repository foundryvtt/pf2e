...
export const WEAPON_PROPERTY_RUNE_DATA: Record<WeaponPropertyRuneType, RuneValuationData> = {
    ...
    fearsome: { level: 5, price: 160, rarity: "common", traits: ["emotion", "enchantment", "fear", "magical", "mental"] },
    ...
    greaterFearsome: { level: 12, price: 2000, rarity: "common", traits: ["emotion", "enchantment", "fear", "magical", "mental"] },
