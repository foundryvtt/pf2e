...
import type { BooleanField, DataSchema, EmbeddedDataField, StringField } from "types/foundry/common/data/fields.d.ts";
...
type RollOptionSchema = RuleElementSchema & {
    ...
    suboptions: DataUnionField<SuboptionsArrayField | SuboptionsRefField, false, false, true>;
    /**
...
type SuboptionsArrayField = StrictArrayField<SuboptionField>;
type SuboptionsRefField = StrictStringField<string, string, true, false, false>;
...
export { Suboption };
export type { RollOptionSchema, SuboptionField, SuboptionSource, SuboptionsArrayField };
