...
type GrantItemSchema = RuleElementSchema & {
    ...
    onDeleteActions: fields.SchemaField<{
        granter: fields.StringField<ItemGrantDeleteAction, ItemGrantDeleteAction, true, true, true>;
        grantee: fields.StringField<ItemGrantDeleteAction, ItemGrantDeleteAction, true, true, true>;
    }>;
