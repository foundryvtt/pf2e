...
import { DamageCalculationRuleElement } from './elements/damage-calculation';
...
export class PF2RuleElements {
    ...
    > = Object.freeze({
        ...
        'PF2E.RuleElement.DamageCalculation': (ruleData, item) => new DamageCalculationRuleElement(ruleData, item),
    });
