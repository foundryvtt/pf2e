...
class ChatDamageButtonsPF2e extends Application {
  init() {
    ...
    Hooks.on('renderChatMessage', (message, html, data) => {
      ...
      const full = $(`<button style="flex: 1 1 0;" title="Apply full damage to selected tokens."><i class="fas fa-user-minus"></i></button>`);
      const double = $(`<button style="flex: 1 1 0;" title="Apply double damage to selected tokens."><i class="fas fa-user-injured"></i></button>`);
      const half = $(`<button style="flex: 1 1 0;" title="Apply half damage to selected tokens."><i class="fas fa-user-shield"></i></button>`);
      ...
      const heal = $(`<button style="flex: 1 1 0;" title="Apply full healing to selected tokens."><i class="fas fa-user-plus"></i></button>`);
