...
const ancestryTraits = {
    ...
    barathu: "SF2E.TraitBarathu",
    beastkin: "PF2E.TraitBeastkin",
    borai: "SF2E.TraitBorai",
...
const creatureTraits = {
    ...
    jinsul: "SF2E.TraitJinsul",
    kaiju: "PF2E.TraitKaiju",
    kami: "PF2E.TraitKami",
    kothama: "SF2E.TraitKothama",
    kovintus: "PF2E.TraitKovintus",
    kucharn: "SF2E.TraitKucharn",
...
const classTraits: Record<ClassTrait, string> = {
    ...
    monk: "PF2E.TraitMonk",
    mystic: "SF2E.TraitMystic",
    operative: "SF2E.TraitOperative",
    oracle: "PF2E.TraitOracle",
    psychic: "PF2E.TraitPsychic",
    ranger: "PF2E.TraitRanger",
    rogue: "PF2E.TraitRogue",
    solarian: "SF2E.TraitSolarian",
    soldier: "SF2E.TraitSoldier",
    ...
    witchwarper: "SF2E.TraitWitchwarper",
...
const weaponTraits = {
    ...
    alchemical: "PF2E.TraitAlchemical",
    analog: "SF2E.TraitAnalog",
    apex: "PF2E.TraitApex",
    arc: "SF2E.TraitArc",
    archaic: "SF2E.TraitArchaic",
    "area-burst-10": "SF2E.TraitAreaBurst10Ft",
    "area-burst-15": "SF2E.TraitAreaBurst15Ft",
    "area-burst-20": "SF2E.TraitAreaBurst20Ft",
    "area-burst-25": "SF2E.TraitAreaBurst25Ft",
    "area-burst-30": "SF2E.TraitAreaBurst30Ft",
    "area-burst-5": "SF2E.TraitAreaBurst5Ft",
    "area-cone": "SF2E.TraitAreaCone",
    "area-line": "SF2E.TraitAreaLine",
    ...
    attuned: "SF2E.TraitAttuned",
    auditory: "PF2E.TraitAuditory",
    automatic: "SF2E.TraitAutomatic",
    backstabber: "PF2E.TraitBackstabber",
    backswing: "PF2E.TraitBackswing",
    bomb: "PF2E.TraitBomb",
    "boost-1": "SF2E.TraitBoost1",
    "boost-1d10": "SF2E.TraitBoost1d10",
    "boost-1d12": "SF2E.TraitBoost1d12",
    "boost-1d4": "SF2E.TraitBoost1d4",
    "boost-1d6": "SF2E.TraitBoost1d6",
    "boost-1d8": "SF2E.TraitBoost1d8",
    brace: "PF2E.TraitBrace",
    breakdown: "SF2E.TraitBreakdown",
    ...
    "critical-brawling": "SF2E.TraitCriticalBrawling",
    "critical-corrosive": "SF2E.TraitCriticalCorrosive",
    "critical-cryo": "SF2E.TraitCriticalCryo",
    "critical-flame": "SF2E.TraitCriticalFlame",
    "critical-fusion": "PF2E.TraitCriticalFusion",
    "critical-knife": "SF2E.TraitCriticalKnife",
    "critical-mental": "SF2E.TraitCriticalMental",
    "critical-plasma": "SF2E.TraitCriticalPlasma",
    "critical-shock": "SF2E.TraitCriticalShock",
    "critical-sonic": "SF2E.TraitCriticalSonic",
    ...
    emotion: "PF2E.TraitEmotion",
    "expend-1": "SF2E.TraitExpend1",
    "expend-2": "SF2E.TraitExpend2",
    "expend-5": "SF2E.TraitExpend5",
    "expend-10": "SF2E.TraitExpend10",
    extradimensional: "PF2E.TraitExtradimensional",
    ...
    light: "PF2E.TraitLight",
    "mag-1": "SF2E.TraitMag1",
    "mag-2": "SF2E.TraitMag2",
    "mag-3": "SF2E.TraitMag3",
    "mag-4": "SF2E.TraitMag4",
    "mag-5": "SF2E.TraitMag5",
    "mag-6": "SF2E.TraitMag6",
    "mag-7": "SF2E.TraitMag7",
    "mag-8": "SF2E.TraitMag8",
    "mag-10": "SF2E.TraitMag10",
    "mag-20": "SF2E.TraitMag20",
    "mag-30": "SF2E.TraitMag30",
    magical: "PF2E.TraitMagical",
    mental: "PF2E.TraitMental",
    ...
    plant: "PF2E.TraitPlant",
    poison: "PF2E.TraitPoison",
    powered: "SF2E.TraitPowered",
    "professional-computers": "SF2E.TraitProfessionalComputers",
    "professional-crafting": "SF2E.TraitProfessionalCrafting",
    "professional-deception": "SF2E.TraitProfessionalDeception",
    "professional-performance": "SF2E.TraitProfessionalPerformance",
    propulsive: "PF2E.TraitPropulsive",
    "ranged-shove": "SF2E.TraitRangedShove",
    ...
    time: "PF2E.TraitTime",
    "tracking-1": "SF2E.TraitTracking1",
    "tracking-2": "SF2E.TraitTracking2",
    "tracking-3": "SF2E.TraitTracking3",
    ...
    unwieldy: "SF2E.TraitUnwieldy",
    upgrade: "SF2E.TraitUpgrade",
...
const featTraits = {
    ...
    concentrate: "PF2E.TraitConcentrate",
    cycle: "SF2E.TraitCycle",
    dedication: "PF2E.TraitDedication",
    destiny: "PF2E.TraitDestiny",
    detection: "PF2E.TraitDetection",
    deviant: "PF2E.TraitDeviant",
    directive: "SF2E.TraitDirective",
    disharmony: "SF2E.TraitDisharmony",
    ...
    manifestation: "SF2E.TraitManifestation",
    manipulate: "PF2E.TraitManipulate",
    ...
    stance: "PF2E.TraitStance",
    suppressed: "SF2E.TraitSuppressed",
...
const equipmentTraits = {
    ...
    biotech: "SF2E.TraitBiotech",
    censer: "PF2E.TraitCenser",
    ceramic: "SF2E.TraitCeramic",
    charm: "SF2E.TraitCharm",
    clockwork: "PF2E.TraitClockwork",
    coagulant: "PF2E.TraitCoagulant",
    coda: "PF2E.TraitCoda",
    compact: "SF2E.TraitCompact",
    ...
    incorporeal: "PF2E.TraitIncorporeal",
    infused: "PF2E.TraitInfused",
    installed: "SF2E.TraitInstalled",
    intelligent: "PF2E.TraitIntelligent",
    invested: "PF2E.TraitInvested",
    light: "PF2E.TraitLight",
    magical: "PF2E.TraitMagical",
    magitech: "SF2E.TraitMagitech",
    mechanical: "PF2E.TraitMechanical",
    mental: "PF2E.TraitMental",
    misfortune: "PF2E.TraitMisfortune",
    missile: "SF2E.TraitMissile",
    morph: "PF2E.TraitMorph",
    mounted: "PF2E.TraitMounted",
    mythic: "PF2E.TraitMythic",
    nanite: "SF2E.TraitNanite",
    necrograft: "SF2E.TraitNecrograft",
    nonlethal: "PF2E.TraitNonlethal",
    plant: "PF2E.TraitPlant",
    poison: "PF2E.TraitPoison",
    polymer: "SF2E.TraitPolymer",
    polymorph: "PF2E.TraitPolymorph",
    portable: "PF2E.TraitPortable",
    precious: "PF2E.TraitPrecious",
    prediction: "PF2E.TraitPrediction",
    relic: "PF2E.TraitRelic",
    retractable: "SF2E.TraitRetractable",
    revelation: "PF2E.TraitRevelation",
    saggorak: "PF2E.TraitSaggorak",
    scrying: "PF2E.TraitScrying",
    serum: "SF2E.TraitSerum",
    shadow: "PF2E.TraitShadow",
    sleep: "PF2E.TraitSleep",
    spellgun: "PF2E.TraitSpellgun",
...
const armorTraits = {
    ...
    relic: "PF2E.TraitRelic",
    "resilient-1": "SF2E.TraitResilient1",
    "resilient-2": "SF2E.TraitResilient2",
    "resilient-3": "SF2E.TraitResilient3",
    tech: "PF2E.TraitTech",
};
...
const traitDescriptions = {
    ...
    analog: "SF2E.TraitDescriptionAnalog",
    anchoring: "SF2E.TraitDescriptionAnchoring",
    ...
    arc: "SF2E.TraitDescriptionArc",
    arcane: "PF2E.TraitDescriptionArcane",
    archaic: "SF2E.TraitDescriptionArchaic",
    archetype: "PF2E.TraitDescriptionArchetype",
    archon: "PF2E.TraitDescriptionArchon",
    ardande: "PF2E.TraitDescriptionArdande",
    area: "SF2E.TraitDescriptionArea",
    "area-burst-5": "SF2E.TraitDescriptionArea",
    "area-burst-10": "SF2E.TraitDescriptionArea",
    "area-burst-15": "SF2E.TraitDescriptionArea",
    "area-burst-20": "SF2E.TraitDescriptionArea",
    "area-burst-25": "SF2E.TraitDescriptionArea",
    "area-burst-30": "SF2E.TraitDescriptionArea",
    "area-cone": "SF2E.TraitDescriptionArea",
    "area-line": "SF2E.TraitDescriptionArea",
    ...
    attuned: "SF2E.TraitDescriptionAttuned",
    auditory: "PF2E.TraitDescriptionAuditory",
    aura: "PF2E.TraitDescriptionAura",
    automatic: "SF2E.TraitDescriptionAutomatic",
    ...
    biotech: "SF2E.TraitDescriptionBiotech",
    blight: "PF2E.TraitDescriptionBlight",
    boggard: "PF2E.TraitDescriptionBoggard",
    bomb: "PF2E.TraitDescriptionBomb",
    "boost-1": "SF2E.TraitDescriptionBoost",
    "boost-1d4": "SF2E.TraitDescriptionBoost",
    "boost-1d6": "SF2E.TraitDescriptionBoost",
    "boost-1d8": "SF2E.TraitDescriptionBoost",
    "boost-1d10": "SF2E.TraitDescriptionBoost",
    "boost-1d12": "SF2E.TraitDescriptionBoost",
    "bottled-breath": "PF2E.TraitDescriptionBottledBreath",
    brace: "PF2E.TraitDescriptionBrace",
    bravado: "PF2E.TraitDescriptionBravado",
    breakdown: "SF2E.TraitDescriptionBreakdown",
    ...
    caster: "SF2E.TraitDescriptionCaster",
    ...
    charm: "SF2E.TraitDescriptionCharm",
    ...
    compact: "SF2E.TraitDescriptionCompact",
    ...
    "critical-brawling": "SF2E.TraitDescriptionCritical",
    "critical-corrosive": "SF2E.TraitDescriptionCritical",
    "critical-cryo": "SF2E.TraitDescriptionCritical",
    "critical-flame": "SF2E.TraitDescriptionCritical",
    "critical-fusion": "PF2E.TraitDescriptionCriticalFusion",
    "critical-knife": "SF2E.TraitDescriptionCritical",
    "critical-mental": "SF2E.TraitDescriptionCritical",
    "critical-plasma": "SF2E.TraitDescriptionCritical",
    "critical-shock": "SF2E.TraitDescriptionCritical",
    "critical-sonic": "SF2E.TraitDescriptionCritical",
    curse: "PF2E.TraitDescriptionCurse",
    cursebound: "PF2E.TraitDescriptionCursebound",
    cursed: "PF2E.TraitDescriptionCursed",
    cycle: "SF2E.TraitDescriptionCycle",
    ...
    directive: "SF2E.TraitDescriptionDirective",
    disarm: "PF2E.TraitDescriptionDisarm",
    disease: "PF2E.TraitDescriptionDisease",
    disharmony: "SF2E.TraitDescriptionDisharmony",
    ...
    exposed: "SF2E.TraitDescriptionExposed",
    ...
    grenade: "SF2E.TraitDescriptionGrenade",
    ...
    installed: "SF2E.TraitDescriptionInstalled",
    ...
    magitech: "SF2E.TraitDescriptionMagitech",
    magus: "PF2E.TraitDescriptionMagus",
    manifestation: "SF2E.TraitDescriptionManifestation",
    ...
    missile: "SF2E.TraitDescriptionMissile",
    ...
    powered: "SF2E.TraitDescriptionPowered",
    ...
    "professional-computers": "SF2E.TraitDescriptionProfessional",
    "professional-crafting": "SF2E.TraitDescriptionProfessional",
    "professional-deception": "SF2E.TraitDescriptionProfessional",
    "professional-performance": "SF2E.TraitDescriptionProfessional",
    ...
    "ranged-shove": "SF2E.TraitDescriptionRangedShove",
    ...
    retractable: "SF2E.TraitDescriptionRetractable",
    ...
    serum: "SF2E.TraitDescriptionSerum",
    ...
    suppressed: "SF2E.TraitDescriptionSuppressed",
    ...
    tech: "SF2E.TraitDescriptionTech",
    ...
    thought: "SF2E.TraitDescriptionThought",
    ...
    "tracking-1": "SF2E.TraitDescriptionTracking",
    "tracking-2": "SF2E.TraitDescriptionTracking",
    "tracking-3": "SF2E.TraitDescriptionTracking",
    training: "PF2E.TraitDescriptionTraining",
    transcendence: "PF2E.TraitDescriptionTranscendence",
    transfer: "SF2E.TraitDescriptionTransfer",
    ...
    unwieldy: "SF2E.TraitDescriptionUnwieldy",
    upgrade: "SF2E.TraitDescriptionUpgrade",
    ...
    zone: "SF2E.TraitDescriptionZone",
