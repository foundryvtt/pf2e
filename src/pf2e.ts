    ...
    options.push(
        {
            ...
            callback: (li) => PF2EActor.applyDamage({ roll: li, multiplier: 1 }),
        },
        {
            name: 'Apply Healing',
        ...
        },
        {
            ...
            condition: canApplyDamage,
            callback: (li) => PF2EActor.applyDamage({ roll: li, multiplier: 2 }),
        },
        {
            name: 'Half Damage',
            icon: '<i class="fas fa-user-shield"></i>',
            condition: canApplyDamage,
            callback: (li) => PF2EActor.applyDamage({ roll: li, multiplier: 0.5 }),
        },
        {
