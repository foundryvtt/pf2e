...
declare class Actor<DataType> extends Entity<DataType> {
    ...
    /** @override */
    createEmbeddedEntity(embeddedName: string, createData: object, options?: object): Promise<SystemActorType>;

    /** @override */
    updateEmbeddedEntity(embeddedName: string, updateData: object, options?: object): Promise<SystemActorType>;

    /** @override */
    deleteEmbeddedEntity(embeddedName: string, childId: string, options?: object): Promise<SystemActorType>;
