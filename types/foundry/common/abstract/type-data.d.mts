...
> extends abstract.DataModel<TParent, TSchema> {
     ...
     */
    protected _preCreate(data: this["_source"], options: object, user: User): Promise<boolean | void>;
     ...
     */
    protected _onCreate(data: this["_source"], options: object, userId: string): void;
