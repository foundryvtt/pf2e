...
export default class CompendiumDirectory extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    protected override _prepareContext(options: HandlebarsRenderOptions): Promise<CompendiumDirectoryContext>;
...
export type PackSummaryByEntity = Record<CompendiumDocumentType, PackSummary>;

export interface CompendiumDirectoryContext extends ApplicationConfiguration {
    user: User;
    packs: PackSummaryByEntity;
}

export interface PackSummaryData {
