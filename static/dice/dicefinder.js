Hooks.on('diceSoNiceReady', (dice3d) => {
    ...
    dice3d.addDicePreset({
        type: "dc",
        labels: [
            "systems/pf2e/dice/basic/tail.webp",
            "systems/pf2e/dice/basic/heads.webp"
        ],
        system: "basic"
    });
    ...
    dice3d.addDicePreset({
        type: "d2",
        labels: [
            "systems/pf2e/dice/basic/tail_bump.webp",
            "systems/pf2e/dice/basic/heads_bump.webp"
        ],
        system: "basic"
    });
    ...
    dice3d.addTexture("transparente", {
        ...
        composite: "source-over",
        source: "systems/pf2e/dice/texture/transparente.webp"
    })
        .then(() => {
            dice3d.addColorset({
                name: 'darkmode',
