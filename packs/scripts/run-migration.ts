...
import { Migration815SpinTaleAdventureSpecific } from "@module/migration/migrations/815-spin-tale-adventure-specific";
...
const migrations: MigrationBase[] = [
    ...
    new Migration815SpinTaleAdventureSpecific(),
];
