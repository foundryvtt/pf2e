...
system.manifest = `https://gitlab.com/${argv.gitlabpath}/-/jobs/artifacts/release-v9/raw/system.json?job=build`;
system.download = `https://gitlab.com/${argv.gitlabpath}/-/jobs/artifacts/release-v9/raw/pf2e.zip?job=build`;
