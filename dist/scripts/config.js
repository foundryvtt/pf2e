...
// Spell Traits
CONFIG.spellTraits = {
  uncommon: 'PF2E.SpellTraitUncommon',
  rare: 'PF2E.SpellTraitRare',
  attack: 'PF2E.SpellTraitAttack',
  disease: 'PF2E.SpellTraitDisease',
  polymorph: 'PF2E.SpellTraitPolymorph',
  incapacitation: 'PF2E.SpellTraitIncapacitation',
  plant: 'PF2E.SpellTraitPlant',
  teleportation: 'PF2E.SpellTraitTeleportation',
  visual: 'PF2E.SpellTraitVisual',
  emotion: 'PF2E.SpellTraitEmotion',
  light: 'PF2E.SpellTraitLight',
  darkness: 'PF2E.SpellTraitDarkness',
  death: 'PF2E.SpellTraitDeath',
  scrying: 'PF2E.SpellTraitScrying',
  detection: 'PF2E.SpellTraitDetection',
  composition: 'PF2E.SpellTraitComposition',
  water: 'PF2E.SpellTraitWater',
  acid: 'PF2E.SpellTraitAcid',
  bludgeoning: 'PF2E.SpellTraitBludgeoning',
  cold: 'PF2E.SpellTraitCold',
  fire: 'PF2E.SpellTraitFire',
  force: 'PF2E.SpellTraitForce',
  electricity: 'PF2E.SpellTraitElectricity',
  sonic: 'PF2E.SpellTraitSonic',
  negative: 'PF2E.SpellTraitNegative',
  piercing: 'PF2E.SpellTraitPiercing',
  poison: 'PF2E.SpellTraitPoison',
  psychic: 'PF2E.SpellTraitPsychic',
  positive: 'PF2E.SpellTraitPositive',
  bleed: 'PF2E.SpellTraitBleed',
  mental: 'PF2E.SpellTraitMental',
  precision: 'PF2E.SpellTraitPrecision',
  slashing: 'PF2E.SpellTraitSlashing',
  chaotic: 'PF2E.SpellTraitChaotic',
  lawful: 'PF2E.SpellTraitLawful',
  good: 'PF2E.SpellTraitGood',
  evil: 'PF2E.SpellTraitEvil',
  healing: 'PF2E.SpellTraitHealing',
  cantrip: 'PF2E.SpellTraitCantrip',
  nonlethal: 'PF2E.SpellTraitNonlethal',
  arcane: 'PF2E.SpellTraitArcane',
  divine: 'PF2E.SpellTraitDivine',
  occult: 'PF2E.SpellTraitOccult',
  primal: 'PF2E.SpellTraitPrimal',
  abjuration: 'PF2E.SpellTraitAbjuration',
  conjuration: 'PF2E.SpellTraitConjuration',
  divination: 'PF2E.SpellTraitDivination',
  enchantment: 'PF2E.SpellTraitEnchantment',
  evocation: 'PF2E.SpellTraitEvocation',
  illusion: 'PF2E.SpellTraitIllusion',
  necromancy: 'PF2E.SpellTraitNecromancy',
  transmutation: 'PF2E.SpellTraitTransmutation',
  alchemist: 'PF2E.SpellTraitAlchemist',
  barbarian: 'PF2E.SpellTraitBarbarian',
  bard: 'PF2E.SpellTraitBard',
  champion: 'PF2E.SpellTraitChampion',
  cleric: 'PF2E.SpellTraitCleric',
  druid: 'PF2E.SpellTraitDruid',
  fighter: 'PF2E.SpellTraitFighter',
  monk: 'PF2E.SpellTraitMonk',
  ranger: 'PF2E.SpellTraitRanger',
  rogue: 'PF2E.SpellTraitRogue',
  sorcerer: 'PF2E.SpellTraitSorcerer',
  wizard: 'PF2E.SpellTraitWizard',
  earth: 'PF2E.SpellTraitEarth',
  curse: 'PF2E.SpellTraitCurse',
  misfortune: 'PF2E.SpellTraitMisfortune',
  fungus: 'PF2E.SpellTraitFungus',
  linguistic: 'PF2E.SpellTraitLinguistic',
  morph: 'PF2E.SpellTraitMorph',
};

// Feat Traits
CONFIG.featTraits = {
  uncommon: 'PF2E.FeatTraitUncommon',
  rare: 'PF2E.FeatTraitRare',
  attack: 'PF2E.FeatTraitAttack',
  move: 'PF2E.FeatTraitMove',
  manipulate: 'PF2E.FeatTraitManipulate',
  concentrate: 'PF2E.FeatTraitConcentrate',
  rage: 'PF2E.FeatTraitRage',
  general: 'PF2E.FeatTraitGeneral',
  skill: 'PF2E.FeatTraitSkill',
  dwarf: 'PF2E.FeatTraitDwarf',
  elf: 'PF2E.FeatTraitElf',
  gnome: 'PF2E.FeatTraitGnome',
  goblin: 'PF2E.FeatTraitGoblin',
  halfling: 'PF2E.FeatTraitHalfling',
  human: 'PF2E.FeatTraitHuman',
  alchemist: 'PF2E.FeatTraitAlchemist',
  barbarian: 'PF2E.FeatTraitBarbarian',
  bard: 'PF2E.FeatTraitBard',
  champion: 'PF2E.FeatTraitChampion',
  cleric: 'PF2E.FeatTraitCleric',
  druid: 'PF2E.FeatTraitDruid',
  fighter: 'PF2E.FeatTraitFighter',
  monk: 'PF2E.FeatTraitMonk',
  ranger: 'PF2E.FeatTraitRanger',
  rogue: 'PF2E.FeatTraitRogue',
  sorcerer: 'PF2E.FeatTraitSorcerer',
  wizard: 'PF2E.FeatTraitWizard',
  fortune: 'PF2E.FeatTraitFortune',
  healing: 'PF2E.FeatTraitHealing',
  downtime: 'PF2E.FeatTraitDowntime',
  secret: 'PF2E.FeatTraitSecret',
  additive1: 'PF2E.FeatTraitAdditive1',
  additive2: 'PF2E.FeatTraitAdditive2',
  additive3: 'PF2E.FeatTraitAdditive3',
  air: 'PF2E.FeatTraitAir',
  archetype: 'PF2E.FeatTraitArchetype',
  auditory: 'PF2E.FeatTraitAuditory',
  dedication: 'PF2E.FeatTraitDedication',
  detection: 'PF2E.FeatTraitDetection',
  emotion: 'PF2E.FeatTraitEmotion',
  exploration: 'PF2E.FeatTraitExploration',
  fear: 'PF2E.FeatTraitFear',
  flourish: 'PF2E.FeatTraitFlourish',
  'half-Elf': 'PF2E.FeatTraitHalfElf',
  'half-Orc': 'PF2E.FeatTraitHalfOrc',
  incapacitation: 'PF2E.FeatTraitIncapacitation',
  instinct: 'PF2E.FeatTraitInstinct',
  magical: 'PF2E.FeatTraitMagical',
  metamagic: 'PF2E.FeatTraitMetamagic',
  morph: 'PF2E.FeatTraitMorph',
  multiclass: 'PF2E.FeatTraitMulticlass',
  oath: 'PF2E.FeatTraitOath',
  open: 'PF2E.FeatTraitOpen',
  polymorph: 'PF2E.FeatTraitPolymorph',
  press: 'PF2E.FeatTraitPress',
  stance: 'PF2E.FeatTraitStance',
  visual: 'PF2E.FeatTraitVisual',
  arcane: 'PF2E.FeatTraitArcane',
  divine: 'PF2E.FeatTraitDivine',
  occult: 'PF2E.FeatTraitOccult',
  primal: 'PF2E.FeatTraitPrimal',
  abjuration: 'PF2E.FeatTraitAbjuration',
  conjuration: 'PF2E.FeatTraitConjuration',
  divination: 'PF2E.FeatTraitDivination',
  enchantment: 'PF2E.FeatTraitEnchantment',
  evocation: 'PF2E.FeatTraitEvocation',
  illusion: 'PF2E.FeatTraitIllusion',
  necromancy: 'PF2E.FeatTraitNecromancy',
  transmutation: 'PF2E.FeatTraitTransmutation',
  positive: 'PF2E.FeatTraitPositive',
  negative: 'PF2E.FeatTraitNegative',
  mental: 'PF2E.FeatTraitMental',
  alchemical: 'PF2E.FeatTraitAlchemical',
  fire: 'PF2E.FeatTraitFire',
  acid: 'PF2E.FeatTraitAcid',
  interact: 'PF2E.FeatTraitInteract',
  linguistic: 'PF2E.FeatTraitLinguistic',
  hobgoblin: 'PF2E.FeatTraitHobgoblin',
  leshy: 'PF2E.FeatTraitLeshy',
  lizardfolk: 'PF2E.FeatTraitLizardfolk',
  aasimar: 'PF2E.FeatTraitAasimar',
  catfolk: 'PF2E.FeatTraitCatfolk',
  changeling: 'PF2E.FeatTraitChangeling',
  geniekin: 'PF2E.FeatTraitGeniekin',
  tiefling: 'PF2E.FeatTraitTiefling',
  misfortune: 'PF2E.FeatTraitMisfortune',
  precision: 'PF2E.FeatTraitPrecision',
  aura: 'PF2E.FeatTraitAura',
  curse: 'PF2E.FeatTraitCurse',
  earth: 'PF2E.FeatTraitEarth',
  olfactory: 'PF2E.FeatTraitOlfactory',
};
...
// Class Traits
CONFIG.classTraits = {
  alchemist: 'PF2E.ClassTraitAlchemist',
  barbarian: 'PF2E.ClassTraitBarbarian',
  bard: 'PF2E.ClassTraitBard',
  champion: 'PF2E.ClassTraitChampion',
  cleric: 'PF2E.ClassTraitCleric',
  druid: 'PF2E.ClassTraitDruid',
  fighter: 'PF2E.ClassTraitFighter',
  monk: 'PF2E.ClassTraitMonk',
  ranger: 'PF2E.ClassTraitRanger',
  rogue: 'PF2E.ClassTraitRogue',
  sorcerer: 'PF2E.ClassTraitSorcerer',
  wizard: 'PF2E.ClassTraitWizard',
};

// Ancestry Traits
CONFIG.ancestryTraits = {
  dwarf: 'PF2E.AncestryTraitDwarf',
  elf: 'PF2E.AncestryTraitElf',
  gnome: 'PF2E.AncestryTraitGnome',
  goblin: 'PF2E.AncestryTraitGoblin',
  halfelf: 'PF2E.AncestryTraitHalfelf',
  halfling: 'PF2E.AncestryTraitHalfling',
  halforc: 'PF2E.AncestryTraitHalforc',
  human: 'PF2E.AncestryTraitHuman',
  hobgoblin: 'PF2E.AncestryTraitHobgoblin',
  leshy: 'PF2E.AncestryTraitLeshy',
  lizardfolk: 'PF2E.AncestryTraitLizardfolk',
};
